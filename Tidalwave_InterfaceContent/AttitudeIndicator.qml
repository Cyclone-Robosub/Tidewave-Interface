...
Item {
    ...
    CustomImage {
        anchors.fill: parent
        source: "Resources/Images/ai/ai_back.svg"
        rotation: -roll
    }
    ...
    CustomImage {
        id: face
        anchors.fill: parent
        source: "Resources/Images/ai/ai_face.svg"
    ...
    CustomImage {
        anchors.fill: parent
        source: "Resources/Images/ai/ai_ring.svg"
        rotation: -roll
    }

    CustomImage {
        anchors.fill: parent
        source: "Resources/Images/ai/ai_case.svg"
    }
}
